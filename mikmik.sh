#!/bin/bash
# VPS Installer
# Script by Jubiar Marvin
#
# Illegal selling and redistribution of this script is strictly prohibited
# Please respect author's Property
# Free Script Not For Sale.
# Support All Maker & User
# With You
#
#
...
MyScriptName='JubiarMik SSH,SSL,SDNS'
...
# Your SSH Banner
SSH_Banner='https://raw.githubusercontent.com/michaeleabalos/sshsslovpn_ws/main/SshBanner'
...
cat <<EOF152> /var/www/openvpn/MIKGTMConfig.ovpn
# Credits to JubiarMarvin
...
cat <<EOF16> /var/www/openvpn/MIK-TU-UDP.ovpn
# Credits to JubiarMarvin
...
cat <<EOF160> /var/www/openvpn/MIK-Stories-TCP.ovpn
# Credits to JubiarMarvin
...
cat <<EOF17> /var/www/openvpn/MIK-GAMES.ovpn
# Credits to JubiarMarvin
...
<!-- OVPN Download site by JubiarMik Script -->
...
mySiteOvpn
 ...
 cd /var/www/openvpn
 zip -qq -r MikMikConfigs.zip *.ovpn
 cd
}
...
wget -q 'http://script.psytech-vpn.com/DexterEskalarte/sshsslovpn_ws/websocket/menu.zip'
unzip -qq menu.zip
rm -f menu.zip
chmod +x ./*
dos2unix ./* &> /dev/null
...
function ScriptMessage(){
 ...
 echo -e " Remoded by Jubiar Marvin"
 echo -e ""
}
...
RESPONSE = 'HTTP/1.1 101 <font color="purple">JubiarMik Script</font>\r\n\r\nContent-Length: 104857600000\r\n\r\n'
...
RESPONSE = 'HTTP/1.1 101 <font color="red">Jubiar Marvin Configs</font>\r\n\r\nContent-Length: 104857600000\r\n\r\n'
...
systemctl restart openvpn
 ...
 echo -ne "\033[0mcurl -sO https://raw.githubusercontent.com/michaeleabalos/slow-dns-main-scripts/main/slowdns && chmod +x slowdns && ./slowdns " && echo $(cat nameserver.txt /root/server.pub)
 echo -e ""
